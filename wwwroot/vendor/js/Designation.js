...
function getTableEmployee()
{
    ...
    $('#tblDesignation').DataTable({
        ...
        "bDestroy": true,
        "ajax": {
            "url": apiUrl + 'Designation/GetTableData?action=GetTableData',
            "type": "GET",
            "datatype": "json",
        },
...
$(document).on("click", ".btnDelete", function () {
    ...
    Swal.fire({
        ...
        if (result.value == true) {
            $.ajax({
                type: "DELETE",
                url: apiUrl + 'Designation/DeleteDesignation?action=delete&id=' + UpdateEmployeeID,
                contentType: "application/json; charset=utf-8",
                success: function (result) {
...
$('#btnSave').on('click', function () {
    ...
    if (DesignationName == "") {
        ...
        $('#designationName').removeClass('error');
        $('#error_name').html('');
    }
   ...
   // console.log(obj);
    $.ajax({
        type: "POST",
        url: apiUrl + 'Designation/InsertDesignation',
...
$('#btnUpdate').on('click', function () {
    ...
    var obj = {
        action: 'update',
        designationID: UpdateEmployeeID,
        designationName: DesignationName,
    ...
    $.ajax({
        type: "PUT",
        url: apiUrl + 'Designation/UpdateDesignation',
        data: JSON.stringify(obj),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (result) {
